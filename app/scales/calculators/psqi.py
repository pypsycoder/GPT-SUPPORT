# ============================================
# PSQI Calculator: Расчёт 7 компонентов качества сна
# ============================================
# Рассчитывает глобальный балл PSQI по 7 компонентам:
# субъективное качество, латентность, длительность, эффективность,
# нарушения сна, снотворные, дневная дисфункция.
# Также выявляет клинические флаги (апноэ, СБН, парасомнии).
