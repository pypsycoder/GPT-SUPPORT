...
ручное тестирование по ``new_agent_comcept/MANUAL_TEST_PLAN.md``, см. память
проекта); разные персоны и сценарии остаются различимы по ``thread_id``/
...
# (see new_agent_comcept/MANUAL_TEST_PLAN.md) — нужен только для FK телеметрии
