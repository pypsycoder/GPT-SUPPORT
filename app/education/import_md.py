# ============================================
# Education Import: Импорт уроков из Markdown
# ============================================
# Парсит .md-файлы по заголовкам ## и создаёт Lesson + LessonCard в БД.
# Поддерживает импорт одного файла или всей папки.
