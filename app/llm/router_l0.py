...
# Если рядом с отчётом о сне есть жалоба на состояние — это не «внеси в трекер»,
# а повод для живого ответа. Детектор эмоций (_carries_emotion) такие короткие
# бытовые формулировки не всегда ловит.
_SLEEP_DISTRESS_RE = _p(
...
def classify(
    ...
    *,
    ...
    if (
        ...
        and "?" not in message
        and not concern
        and not _SLEEP_DISTRESS_RE.search(message)
