...
# независимо продублирована как минимум в четырёх местах
# (agent/prompts.py, agent/judge.py, langgraph_supervisor/policy.py,
# router_l2.py) с расхождениями в точной фразе — здесь один источник правды,
