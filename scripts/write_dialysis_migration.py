"""One-off script to write dialysis migration (alembic/versions is in .cursorignore)."""
from pathlib import Path

CONTENT = '''"""Dialysis centers and schedules: centers, users.center_id, dialysis_schedules.
...
def main():
    ...
    path = root / "alembic" / "versions" / "20260210_01_dialysis_centers_schedules.py"
